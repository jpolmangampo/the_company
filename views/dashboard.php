                    ...
                    <tr>
                        <td>
                            ...
                            <?php
                                ...
                                ?>
                            <i class="fa-solid fa-solid fa-user text-secondary 
                        ...
                        <td>
                            <?php
                                ...
                                ?>
                            <a href="edit-user.php" class="btn btn-outline-warning border-0" title="Edit">
                                <i class="fa-regular fa-pen-to-square"></i>
                            </a>
                            <a href="delete-user.php" class="btn btn-outline-danger border-0" title="Delete">
